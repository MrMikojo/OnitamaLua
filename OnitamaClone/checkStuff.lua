...
function checkStuffLoad()
    ...
    redTigerInst = love.graphics.newImage("sprites/redTigerInst.png")
...
function checkStuffUpdate(dt)
    ...
    checkBluesMoves()
    checkredsMoves()
	-- had all the checkSlots in one function, trying to split them up
...
function checkSlot1()
    if gameState == 1 then
        for j, C in ipairs (cards) do 
            ...
            if tiger.x == 0 and tiger.y == 32 then
                blueBannerSprite2 = tigerBlueInst
                

            elseif dragon.y == 32 and dragon.x == 0  then
                    blueBannerSprite2 = dragonBlueInst
            

            elseif rooster.y == 32 and rooster.x == 0 then

                blueBannerSprite2 = blueRoosterInst
            --  print("STILL WORKING!!!!")
                
            elseif cobra.x ==0 and cobra.y == 32 then
                blueBannerSprite2 = blueCobraInst
                
            elseif frog.x == 0 and frog.y == 32 then
	...
	function checkSlot2()
        if gameState == 1 then
            for j, C in ipairs (cards) do 
                        ...
                        if tiger.x == 0 and tiger.y == 128 then
                            blueBannerSprite2 = tigerBlueInst
                            

                        elseif dragon.y == 128 and dragon.x == 0 then
                                blueBannerSprite2 = dragonBlueInst
                            

                        elseif rooster.y == 128 and rooster.x == 0 then

                            blueBannerSprite2 = blueRoosterInst
                        --  print("STILL WORKING!!!!")
                
                        elseif cobra.y ==128 and cobra.x == 0 then
                            blueBannerSprite2 = blueCobraInst
                          
                        elseif frog.y == 128 and frog.x == 0 then
    ...
    function checkSlot3()
        if gameState == 2 then
            for j, C in ipairs (cards) do 
                ...
                if tiger.x == 224 and tiger.y == 32 then
                        redBannerSprite1 = redTigerInst  
                    ...
                    if C.y == 32 then
                        ...
                        if tiger.cardName == "tiger" then
                            redBannerSprite1 = redTigerInst  

                        elseif dragon.cardName == "dragon" then
                            redBannerSprite1 = dragonRedInst
                            --       print("is this working????")

                        elseif rooster.cardName == "rooster" then
                            redBannerSprite1 = redRoosterInst

                        elseif cobra.cardName == "cobra" then
                            redBannerSprite1 = redCobraInst
                            print("is this working????")
                        elseif frog.cardName == "frog" then
                            redBannerSprite1 = redFrogInst
                        end
                            ]]

                    
                elseif dragon.x == 224 and dragon.y == 32 then
                        redBannerSprite1 = dragonRedInst
                        --       print("is this working????")
                    

                elseif rooster.x == 224 and rooster.y == 32 then
                        redBannerSprite1 = redRoosterInst

                    

                elseif cobra.x == 224 and cobra.y == 32 then
                    redBannerSprite1 = redCobraInst
                    

                elseif frog.x == 224 and frog.y == 32 then
                        redBannerSprite1 = redFrogInst
...
function checkSlot4()
    if gameState == 2 then
        for j, C in ipairs (cards) do 
                ...
                if tiger.y == 128 and tiger.x == 224 then
                    redBannerSprite2 = redTigerInst  
                    
                elseif dragon.y == 128 and dragon.x == 224 then
                    redBannerSprite2 = dragonRedInst
                    
                elseif rooster.y == 128 and rooster.x == 224 then
                    redBannerSprite2 = redRoosterInst
                    
                elseif cobra.y == 128 and cobra.x == 224 then
                    redBannerSprite2 = redCobraInst
                    print("SLOTSS FOUR!!!")
                    
                elseif frog.y == 128 and frog.x == 224 then
...
function checkBluesMoves()
    
    for i, B in ipairs (bluePawns) do

        if B.dragonMove == 1 and B.tigerMove == 1 then
            blueBannerSprite1 = dragonBlueInst

            blueBannerSprite2   = tigerBlueInst
        
        elseif B.dragonMove == 1 and B.roosterMove == 1 then
            blueBannerSprite1 = dragonBlueInst

            blueBannerSprite2   = blueRoosterInst
        
        elseif B.dragonMove == 1 and B.cobraMove == 1 then
            blueBannerSprite1 = dragonBlueInst

            blueBannerSprite2   = blueCobraInst
        elseif  B.dragonMove == 1 and  B.frogMove == 1 then
            blueBannerSprite1 = dragonBlueInst

            blueBannerSprite2   = blueFrogInst
    
        elseif B.tigerMove == 1 and B.roosterMove == 1 then
        
             blueBannerSprite1 = tigerBlueInst

             blueBannerSprite2   = blueRoosterInst
        
        elseif B.tigerMove == 1 and B.cobraMove == 1 then
            blueBannerSprite1 = tigerBlueInst

            blueBannerSprite2   = blueCobraInst
        
        elseif B.tigerMove == 1 and B.frogMove == 1 then
            
            blueBannerSprite1 = tigerBlueInst

            blueBannerSprite2   = blueFrogInst
        
        elseif B.roosterMove == 1 and B.cobraMove == 1 then
            
            blueBannerSprite1   = blueRoosterInst
            blueBannerSprite2   = blueCobraInst
        
        elseif B.roosterMove == 1 and B.frogMove == 1 then
          blueBannerSprite1   = blueRoosterInst
            blueBannerSprite2   = blueFrogInst  
        
        elseif B.cobraMove == 1 and B.frogMove == 1 then
...
function checkredsMoves()
    for i, B in ipairs (redPawns) do
